...
/*droping all tables before reruning initializations*/
DROP TABLE `lab4_rds`.`account`, `lab4_rds`.`branch`, `lab4_rds`.`business`, `lab4_rds`.`customer`, `lab4_rds`.`department`, `lab4_rds`.`employee`, `lab4_rds`.`individual`, `lab4_rds`.`officer`, `lab4_rds`.`product`, `lab4_rds`.`product_type`, `lab4_rds`.`transaction`;
...
alter table employee add constraint fk_e_emp_id1
foreign key (superior_emp_id) references employee (emp_id);
